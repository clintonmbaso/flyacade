...
if (typeof window.registerWorksheet !== 'undefined') {
    ...
    console.log("english-week3.js registered using registerWorksheet()");
} else if (typeof window.DataLoader !== 'undefined') {
    window.DataLoader.registerWorksheet(grade1EnglishWeek3);
    console.log("english-week3.js registered using DataLoader.registerWorksheet()");
} else {
    ...
    console.log("english-week3.js stored in window.registeredWorksheets");
}

// Also expose it globally for backward compatibility
window.grade1EnglishWeek3 = grade1EnglishWeek3;
console.log("english-week3.js loaded and registered successfully");