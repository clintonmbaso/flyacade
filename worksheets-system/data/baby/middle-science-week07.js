...
if (typeof window.registerWorksheet !== 'undefined') {
    window.registerWorksheet(receptionScienceWeek7);
    console.log("receptionScienceWeek7.js registered using registerWorksheet()");
} else if (typeof window.DataLoader !== 'undefined') {
    window.DataLoader.registerWorksheet(receptionScienceWeek7);
    console.log("receptionScienceWeek7.js registered using DataLoader.registerWorksheet()");
} else {
    ...
    window.registeredWorksheets.push({
        variableName: 'receptionScienceWeek7',
        metadata: receptionScienceWeek7.metadata,
        days: receptionScienceWeek7
    });
    console.log("receptionScienceWeek7.js stored in window.registeredWorksheets");
}

// Also expose it globally for backward compatibility
window.receptionScienceWeek7 = receptionScienceWeek7;
console.log("receptionScienceWeek7.js loaded and registered successfully");