...
if (typeof window.registerWorksheet !== 'undefined') {
    window.registerWorksheet(babyScienceWeek3);
    console.log("babyScienceWeek3.js registered using registerWorksheet()");
} else if (typeof window.DataLoader !== 'undefined') {
    window.DataLoader.registerWorksheet(babyScienceWeek3);
    console.log("babyScienceWeek3.js registered using DataLoader.registerWorksheet()");
} else {
    ...
    window.registeredWorksheets.push({
        variableName: 'babyScienceWeek3',
        metadata: babyScienceWeek3.metadata,
        days: babyScienceWeek3
    });
    console.log("babyScienceWeek3.js stored in window.registeredWorksheets");
}

// Also expose it globally for backward compatibility
window.babyScienceWeek3 = babyScienceWeek3;
console.log("babyScienceWeek3.js loaded and registered successfully");