...
if (typeof window.registerWorksheet !== 'undefined') {
    window.registerWorksheet(babyClassScienceWeek8);
    console.log("babyClassScienceWeek8.js registered using registerWorksheet()");
} else if (typeof window.DataLoader !== 'undefined') {
    window.DataLoader.registerWorksheet(babyClassScienceWeek8);
    console.log("babyClassScienceWeek8.js registered using DataLoader.registerWorksheet()");
} else {
    ...
    window.registeredWorksheets.push({
        variableName: 'babyClassScienceWeek8',
        metadata: babyClassScienceWeek8.metadata,
        days: babyClassScienceWeek8
    });
    console.log("babyClassScienceWeek8.js stored in window.registeredWorksheets");
}

// Also expose it globally for backward compatibility
window.babyClassScienceWeek8 = babyClassScienceWeek8;
console.log("babyClassScienceWeek8.js loaded and registered successfully");