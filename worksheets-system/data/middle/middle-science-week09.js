...
if (typeof window.registerWorksheet !== 'undefined') {
    window.registerWorksheet(middleScienceWeek9);
    console.log("middleScienceWeek9.js registered using registerWorksheet()");
} else if (typeof window.DataLoader !== 'undefined') {
    window.DataLoader.registerWorksheet(middleScienceWeek9);
    console.log("middleScienceWeek9.js registered using DataLoader.registerWorksheet()");
} else {
    ...
    window.registeredWorksheets.push({
        variableName: 'middleScienceWeek9',
        metadata: middleScienceWeek9.metadata,
        days: middleScienceWeek9
    });
    console.log("middleScienceWeek9.js stored in window.registeredWorksheets");
}

// Also expose it globally for backward compatibility
window.middleScienceWeek9 = middleScienceWeek9;
console.log("middleScienceWeek9.js loaded and registered successfully");