...
if (typeof window.registerWorksheet !== 'undefined') {
    window.registerWorksheet(middleScienceWeek4);
    console.log("middleScienceWeek4.js registered using registerWorksheet()");
} else if (typeof window.DataLoader !== 'undefined') {
    window.DataLoader.registerWorksheet(middleScienceWeek4);
    console.log("middleScienceWeek4.js registered using DataLoader.registerWorksheet()");
} else {
    ...
    window.registeredWorksheets.push({
        variableName: 'middleScienceWeek4',
        metadata: middleScienceWeek4.metadata,
        days: middleScienceWeek4
    });
    console.log("middleScienceWeek4.js stored in window.registeredWorksheets");
}

// Also expose it globally for backward compatibility
window.middleScienceWeek4 = middleScienceWeek4;
console.log("middleScienceWeek4.js loaded and registered successfully");