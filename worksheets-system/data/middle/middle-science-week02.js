    ...
    wednesday: {
        ...
        lessonContent: `
            ...
            <ul>
                ...
                <li><strong>Tummy:</strong> The middle part of our body</li>
        ...
        examples: `
            <div class="example-box">
                ...
                <p>Can you see the head, Tummy, arms, and legs?</p>
            </div>
            <div class="example-box">
                ...
                <p><strong>Tummy:</strong> Has our heart and stomach</p>
            ...
            <div class="example-box">
                ...
                <p><em>"Head, Tummy, arms, and legs<br>
                These are the body parts that move and beg<br>
                Head for thinking, Tummy in the middle<br>
        ...
        taskContent: `
            ...
            <div class="task-item">
                <span class="task-number">3</span> Point to your Tummy and say "Tummy":
                <span class="answer-space"></span>
            </div>
            <div class="task-item">
        ...
        homework: `
            <div class="homework-box">
                ...
                <div style="border: 1px solid #ccc; padding: 10px; margin: 10px 0;">
                    ...
                    <p>2. Tummy _________ B. Holds our brain for thinking</p>
                ...
                <div style="border: 1px dashed #ccc; padding: 10px; margin: 10px 0;">
                    ...
                    <p>✓ I found the Tummy on: _________________</p>
...
if (typeof window.registerWorksheet !== 'undefined') {
    window.registerWorksheet(middleScienceWeek2);
    console.log("middleScienceWeek2.js registered using registerWorksheet()");
} else if (typeof window.DataLoader !== 'undefined') {
    window.DataLoader.registerWorksheet(middleScienceWeek2);
    console.log("middleScienceWeek2.js registered using DataLoader.registerWorksheet()");
} else {
    ...
    window.registeredWorksheets.push({
        variableName: 'middleScienceWeek2',
        metadata: middleScienceWeek2.metadata,
        days: middleScienceWeek2
    });
    console.log("middleScienceWeek2.js stored in window.registeredWorksheets");
}

// Also expose it globally for backward compatibility
window.middleScienceWeek2 = middleScienceWeek2;
console.log("middleScienceWeek2.js loaded and registered successfully");