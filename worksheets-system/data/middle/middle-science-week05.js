...
if (typeof window.registerWorksheet !== 'undefined') {
    window.registerWorksheet(middleScienceWeek5);
    console.log("middleScienceWeek5.js registered using registerWorksheet()");
} else if (typeof window.DataLoader !== 'undefined') {
    window.DataLoader.registerWorksheet(middleScienceWeek5);
    console.log("middleScienceWeek5.js registered using DataLoader.registerWorksheet()");
} else {
    ...
    window.registeredWorksheets.push({
        variableName: 'middleScienceWeek5',
        metadata: middleScienceWeek5.metadata,
        days: middleScienceWeek5
    });
    console.log("middleScienceWeek5.js stored in window.registeredWorksheets");
}

// Also expose it globally for backward compatibility
window.middleScienceWeek5 = middleScienceWeek5;
console.log("middleScienceWeek5.js loaded and registered successfully");