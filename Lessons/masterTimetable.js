  ...
  const teachers = [
    {
      ...
      subjectPeriods: { Math: 5, Science: 4, English: 4, SDS: 4, "Expressive Arts": 5 },
      className: "Class A",
      periodDuration: 60, // Period duration in minutes
      maxPeriodsPerDay: { default: 5, Friday: 2 }, // 5 periods Mon-Thu, 3 on Friday
    },
    {
      name: "Muwila",
      subjects: ["Math", "Science", "English", "SDS", "Expressive Arts", "Literacy", "SP1"],
      subjectPeriods: { Math: 4, Science: 3, English: 3, SDS: 2, "Expressive Arts": 2, Literacy: 3, SP1: 2 },
      className: "Class A",
      periodDuration: 50,
    ...
    {
      name: "Kaonga",
      subjects: ["Math", "Science", "English", "SDS", "Expressive Arts", "Literacy", "SP1", "SP2"],
      subjectPeriods: { Math: 4, Science: 3, English: 4, SDS: 2, "Expressive Arts": 2, Literacy: 2, SP1: 1, SP2: 1 },
      className: "Class A",
      periodDuration: 40,
      maxPeriodsPerDay: { default: 6, Friday: 2 },
    },
    {
      name: "Muteba",
      subjects: ["Math", "Science", "English", "SDS", "Home Economics", "Literacy", "SP1", "SP2", "Bemba", "Expressive Arts", "Technology Studies"],
      subjectPeriods: { Math: 4, Science: 3, English: 3, SDS: 2, "Home Economics": 2, Literacy: 2, SP1: 2, SP2: 1, Bemba: 3, "Expressive Arts": 2, "Technology Studies": 2 },
      className: "Class A",
      periodDuration: 45,
    ...
    },
    {
      name: "Mbaso",
      subjects: ["Math", "Science", "English", "SDS", "Home Economics", "Literacy", "SP1", "SP2", "Bemba", "Expressive Arts", "Technology Studies"],
      subjectPeriods: { Math: 3, Science: 3, English: 4, SDS: 2, "Home Economics": 2, Literacy: 2, SP1: 2, SP2: 1, Bemba: 3, "Expressive Arts": 2, "Technology Studies": 3 },
      className: "Class A",
      periodDuration: 55,
      maxPeriodsPerDay: { default: 7, Friday: 3 },
    },
