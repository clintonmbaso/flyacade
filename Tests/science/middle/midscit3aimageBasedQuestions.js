const midscit3aimageBasedQuestions = [
    {
        ...
        term: "Term 3",
        part: "Mid Term",
        imageSrc: "images/science/middle/sun.png", // Path to the image (e.g., map image)
    ...
    },
    {
        ...
        term: "Term 3",
        part: "Mid Term",
        imageSrc: "images/science/middle/moon.png", // Path to the image (e.g., map image)
    ...
    },
    {
        ...
        term: "Term 3",
        part: "Mid Term",
        imageSrc: "images/science/middle/star.png", // Path to the image (e.g., map image)
        question: "Identify the source of light during the night.", // Description or prompt for the question
        description: "Image Identification",
        subType: "multiple_choice", // Subtype can be 'multiple_choice' or 'fill_in_the_blank'
        options: ["Sun", "Moon", "Star", "Earth"], // Multiple-choice options
    ...
    },
    {
        ...
        term: "Term 3",
        part: "Mid Term",
        imageSrc: "images/science/middle/earth.png", // Path to the image (e.g., map image)
    ...
    },
    {
        ...
        term: "Term 3",
        part: "Mid Term",
        imageSrc: "images/science/middle/lion.png", // Path to the image (e.g., map image)
        question: "Identify the animal that can see at night.", // Description or prompt for the question
        description: "Image Identification",
        subType: "multiple_choice", // Subtype can be 'multiple_choice' or 'fill_in_the_blank'
        options: ["Owl", "Bat", "Lion", "Cat"], // Multiple-choice options
    ...
    },
    {
        ...
        term: "Term 3",
        part: "Mid Term",
        imageSrc: "images/science/middle/cat.png", // Path to the image (e.g., map image)
        question: "Identify the animal that can see at night.", // Description or prompt for the question
        description: "Image Identification",
        subType: "multiple_choice", // Subtype can be 'multiple_choice' or 'fill_in_the_blank'
        options: ["Owl", "Bat", "Lion", "Cat"], // Multiple-choice options
    ...
    },
    {
        ...
        term: "Term 3",
        part: "Mid Term",
        imageSrc: "images/science/middle/squirrel.png", // Path to the image (e.g., map image)
        question: "Identify the animal that can only see during the day.", // Description or prompt for the question
        description: "Image Identification",
        subType: "multiple_choice", // Subtype can be 'multiple_choice' or 'fill_in_the_blank'
        options: ["Eagle", "Squirrel", "Chicken", "Cow"], // Multiple-choice options
